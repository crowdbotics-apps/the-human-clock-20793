"""the_human_clock_20793 URL Configuration
...
admin.site.site_header = "The Human Clock"
admin.site.site_title = "The Human Clock Admin Portal"
admin.site.index_title = "The Human Clock Admin"

# swagger
api_info = openapi.Info(
    title="The Human Clock API",
    default_version="v1",
    description="API documentation for The Human Clock App",
)
